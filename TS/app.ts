...
// let bird1 : Aves = {
//     bipedal : true , 
//     migrationMonth : "march" , 
//     name : "cuckoo" , 
//     hasWings : true
// }

// // Vehical => interface => sub - interfaces => TATA , Mahindra => child object (cars) (1-1)
...
// type engineer = student & developer & coder
...
// class Car {
//     wheelsC : number  | string
//     nameC : string
//     constructor(wheels : string | number , name : string){
//         this.wheelsC = wheels
//         this.nameC = name
//     } 
...
//     colorC : string | number
//     constructor(wheels : string | number , name : string , color : string | number){
//         super(wheels , name)
//         this.colorC = color
//     } 
// }
// let car1 = new Car(4 , "ion")

// let TATAcar1 = new TATA(4 , "Curvv" , "blue")

// Tuples

let arr : (string | number | boolean)[] = [1  , true , "apple"]

let fruit : [string , number , boolean]
fruit = ["true" , 1 , false]
